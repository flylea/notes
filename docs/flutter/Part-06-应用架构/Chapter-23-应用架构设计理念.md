> **Part**: Part VI — 应用架构
> **上一章**: [Chapter 22 — Supabase 高级](../Part-05-网络与数据/Chapter-22-Supabase高级.md)
> **下一章**: [Chapter 24 — MVVM 模式在 Flutter 中的实现](./Chapter-24-MVVM模式.md)
...
> **下一步**: [Chapter 24 — MVVM 模式在 Flutter 中的实现](./Chapter-24-MVVM模式.md)
