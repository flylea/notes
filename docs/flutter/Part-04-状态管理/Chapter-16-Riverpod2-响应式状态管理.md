> **Part**: Part IV — 状态管理
> **上一章**: [Chapter 15 — 状态管理工程化](./Chapter-15-状态管理工程化.md)
> **下一章**: [Chapter 17 — Bloc 事件驱动状态管理（对比学习）](./Chapter-17-Bloc对比学习.md)
> **官方文档**: [pub.dev/packages/riverpod](https://pub.dev/packages/riverpod) | [riverpod.dev](https://riverpod.dev)

---

# 第 16 章：Riverpod 2.x — 编译时安全的响应式状态管理
...
> **下一步**: [Chapter 17 — Bloc 事件驱动状态管理（对比学习）](./Chapter-17-Bloc对比学习.md)
