...
> **上一章**: [Chapter 42 — 高级 UI 效果](../Part-09-高级UI与体验/Chapter-42-高级UI效果.md)
> **下一章**: [Chapter 44 — 平台通道](./Chapter-44-平台通道.md)
...
> **下一步**: [Chapter 44 — 平台通道：Dart ↔ Native 双向通信](./Chapter-44-平台通道.md)
> **原始文档**: [firebase.google.com/docs/cloud-messaging](https://firebase.google.com/docs/cloud-messaging) | [pub.dev/packages/flutter_local_notifications](https://pub.dev/packages/flutter_local_notifications)
