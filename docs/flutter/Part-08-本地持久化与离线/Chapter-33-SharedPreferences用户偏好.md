...
> **上一章**: [Chapter 32 — 搜索与发现](../Part-07-用户与权限系统/Chapter-32-搜索与发现.md)
> **下一章**: [Chapter 34 — Drift 本地数据库](./Chapter-34-Drift本地数据库.md)
...
# 第 33 章：SharedPreferences 与用户偏好
...
> **下一步**: [Chapter 34 — Drift 本地数据库](./Chapter-34-Drift本地数据库.md)
