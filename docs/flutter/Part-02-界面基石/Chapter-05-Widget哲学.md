...
> **上一章**: [Chapter 04 — Dart 3 新特性与现代 Dart 工程化](../Part-01-起航/Chapter-04-Dart3新特性与工程化基础.md)
> **下一章**: [Chapter 06 — 基础 Widget 全解析](./Chapter-06-基础Widget全解析.md)
...
class GreetingCard extends StatelessWidget {
  ...
  const GreetingCard({
    super.key,              // Key 参数——每个 Widget 都应该接受
...
> **下一步**: [Chapter 06 — 基础 Widget 全解析](./Chapter-06-基础Widget全解析.md)
