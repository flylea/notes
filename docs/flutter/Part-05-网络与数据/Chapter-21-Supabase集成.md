> **Part**: Part V — 网络与数据
> **上一章**: [Chapter 20 — freezed JSON 序列化](./Chapter-20-freezed-JSON序列化.md)
> **下一章**: [Chapter 22 — Supabase Realtime、Edge Functions 与 Auth](./Chapter-22-Supabase高级.md)
...
> **下一步**: [Chapter 22 — Supabase Realtime、Edge Functions 与 Auth](./Chapter-22-Supabase高级.md)
