> **Part**: Part V — 网络与数据
> **上一章**: [Chapter 21 — Supabase 集成](./Chapter-21-Supabase集成.md)
> **下一章**: [Part VI — 应用架构（Chapter 23）](../Part-06-应用架构/)
...
# 第 22 章：Supabase 高级 — Realtime、Edge Functions 与 Auth
...
> **下一步**: [Part VI — 应用架构（Chapter 23）](../Part-06-应用架构/)
