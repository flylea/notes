> **Part**: Part V — 网络与数据
> **上一章**: [Chapter 18 — Dio HTTP 客户端](./Chapter-18-Dio-HTTP客户端.md)
> **下一章**: [Chapter 20 — freezed JSON 序列化与代码生成](./Chapter-20-freezed-JSON序列化.md)
> **官方文档**: [pub.dev/packages/retrofit](https://pub.dev/packages/retrofit)

---

# 第 19 章：Retrofit — 类型安全 API 层
...
> **下一步**: [Chapter 20 — freezed JSON 序列化与代码生成](./Chapter-20-freezed-JSON序列化.md)
